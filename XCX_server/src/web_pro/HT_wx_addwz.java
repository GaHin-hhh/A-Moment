...
/**
 * Servlet implementation class HT_wx_addwz
 */
@WebServlet("/HT_wx_addwz")
public class HT_wx_addwz extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String sql = "insert into sp_data (spmc,spgjz,spcheck,splj,spxq)";
	        sql =sql +"values (?,?,?,?,?)";
